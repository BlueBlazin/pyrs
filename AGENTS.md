...
- Newly landed parity checkpoints:
  ...
  - strict stdlib harness suite now includes `test/test_sqlite3/test_dbapi.py`, `test/test_sqlite3/test_factory.py`, `test/test_sqlite3/test_dump.py`, and `test/test_sqlite3/test_transactions.py` and stays green (`PYRS_RUN_STRICT_STDLIB=1 cargo test -q --test cpython_harness runs_cpython_strict_stdlib_suite`).
