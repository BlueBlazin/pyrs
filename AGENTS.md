...
- Classes: class bodies execute in a class namespace module while resolving missing names against the defining module; methods capture the defining module as globals; C3 MRO is computed at class creation and exposed via `__mro__`; class-header `metaclass=` is compiled and propagated through VM class-frame creation.
