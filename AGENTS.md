...
- Language-surface caveats tracked for later milestones: full async-comprehension parity, full `ExceptionGroup` splitting behavior, full pattern families, and full PEP 701 formatting edge cases remain pending (see roadmap/readiness docs).
