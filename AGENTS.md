...
- Extension scaffolding checkpoint:
  ...
  - ABI coverage baseline is generated from CPython 3.14 `Misc/stable_abi.toml` via `scripts/generate_abi3_manifest.py`; current snapshot is `functions 681/782`, `data 143/143` in `perf/abi3_manifest_latest.json`.
  ...
  - current abi3 manifest coverage: functions `681/782`, data `143/143` (`perf/abi3_manifest_latest.json`).
