...
- Classes: class bodies execute in a class namespace module; methods capture that namespace as their globals (module-level globals for methods not yet modeled).
