...
- Extension scaffolding checkpoint:
  ...
  - C-side varargs handling now also covers `PyArg_ParseTuple`, `PyArg_ParseTupleAndKeywords`, `PyObject_CallFunctionObjArgs`, `PyObject_CallMethod`, `PyEval_CallFunction`, and `PyEval_CallMethod` in `src/vm/capi_variadics.c`.
