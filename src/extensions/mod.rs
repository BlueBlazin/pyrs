...
#[repr(C)]
pub struct PyrsWritableBufferViewV1 {
    pub data: *mut u8,
    pub len: usize,
}
...
pub struct PyrsApiV1 {
    ...
    pub module_set_state: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        state: *mut c_void,
    ...
    pub object_get_writable_buffer: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        object_handle: PyrsObjectHandle,
    ...
    pub capsule_set_pointer: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        capsule_handle: PyrsObjectHandle,
        pointer: *mut c_void,
    ) -> i32,
    ...
    pub capsule_get_destructor: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        capsule_handle: PyrsObjectHandle,
    ) -> Option<PyrsCapsuleDestructorV1>,
    pub capsule_set_name: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        capsule_handle: PyrsObjectHandle,
        name: *const c_char,
    ) -> i32,
    pub capsule_is_valid: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        capsule_handle: PyrsObjectHandle,
        name: *const c_char,
    ) -> i32,
    pub capsule_export:
        unsafe extern "C" fn(module_ctx: *mut c_void, capsule_handle: PyrsObjectHandle) -> i32,
    pub capsule_import: unsafe extern "C" fn(
        module_ctx: *mut c_void,
        name: *const c_char,
        no_block: i32,
    ) -> *mut c_void,
