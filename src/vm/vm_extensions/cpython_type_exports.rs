...
static PY_TYPE_NAME_CLASSMETHOD_DESCR: &[u8; 23] = b"classmethod_descriptor\0";
...
static PY_TYPE_NAME_MEMBER_DESCR: &[u8; 18] = b"member_descriptor\0";
...
static PY_TYPE_NAME_METHOD_DESCR: &[u8; 18] = b"method_descriptor\0";
...
#[unsafe(no_mangle)]
#[used]
pub static mut PyFunction_Type: CpythonTypeObject =
    empty_type(PY_TYPE_NAME_FUNCTION.as_ptr().cast());
#[unsafe(no_mangle)]
#[used]
