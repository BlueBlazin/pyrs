...
"#;
    ...
    pub(super) fn install_stdlib_modules(&mut self) {
        ...
        self.install_builtin_module(
            "platform",
            &[
                ("system", BuiltinFunction::PlatformSystem),
                ("release", BuiltinFunction::PlatformRelease),
                ("version", BuiltinFunction::PlatformVersion),
                ("machine", BuiltinFunction::PlatformMachine),
                ("processor", BuiltinFunction::PlatformProcessor),
                ("node", BuiltinFunction::PlatformNode),
                ("platform", BuiltinFunction::PlatformPlatform),
                ("python_version", BuiltinFunction::PlatformPythonVersion),
                (
                ...
                ("uname", BuiltinFunction::PlatformUname),
            ],
            Vec::new(),
        );
        ...
        self.install_builtin_module(
            ...
            &[
                ...
                ("getuid", BuiltinFunction::OsGetUid),
                ...
                ("readlink", BuiltinFunction::OsReadLink),
                ("symlink", BuiltinFunction::OsSymlink),
        ...
        self.install_builtin_module(
            ...
            &[
                ...
                ("get_type_hints", BuiltinFunction::TypingGetTypeHints),
                ("get_origin", BuiltinFunction::TypingGetOrigin),
                ("get_args", BuiltinFunction::TypingGetArgs),
                (
                    "get_protocol_members",
                    BuiltinFunction::TypingGetProtocolMembers,
                ),
                ("get_overloads", BuiltinFunction::TypingGetOverloads),
                ("clear_overloads", BuiltinFunction::TypingClearOverloads),
                ("is_typeddict", BuiltinFunction::TypingIsTypedDict),
                ("is_protocol", BuiltinFunction::TypingIsProtocol),
            ],
            vec![
        ...
        self.install_builtin_module(
            ...
            vec![
                ...
                ("SIGKILL", Value::Int(SIGNAL_SIGKILL)),
        ...
        self.install_builtin_module(
            "faulthandler",
            &[
                ("enable", BuiltinFunction::FaulthandlerUnsupported),
                ("disable", BuiltinFunction::FaulthandlerDisable),
                ("is_enabled", BuiltinFunction::FaulthandlerIsEnabled),
                ("dump_traceback", BuiltinFunction::FaulthandlerUnsupported),
                (
                ...
                ("register", BuiltinFunction::FaulthandlerUnsupported),
                ("unregister", BuiltinFunction::FaulthandlerUnregister),
                ("dump_c_stack", BuiltinFunction::FaulthandlerUnsupported),
                ("_read_null", BuiltinFunction::FaulthandlerUnsupported),
                ("_sigsegv", BuiltinFunction::FaulthandlerUnsupported),
                ("_sigabrt", BuiltinFunction::FaulthandlerUnsupported),
                ("_sigfpe", BuiltinFunction::FaulthandlerUnsupported),
                ("_stack_overflow", BuiltinFunction::FaulthandlerUnsupported),
                (
    ...
    pub(super) fn maybe_prefer_cpython_pure_stdlib_modules(&mut self) {
        ...
        for module_name in PURE_STDLIB_ABC_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
        ...
        for module_name in PURE_STDLIB_OPERATOR_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
        ...
        for module_name in PURE_STDLIB_COLORIZE_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
        ...
        for module_name in PURE_STDLIB_UUID_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
        ...
        for module_name in PURE_STDLIB_SSL_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
        ...
        for module_name in PURE_STDLIB_SUBPROCESS_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
        ...
        for module_name in PURE_STDLIB_WEAKREF_MODULES {
            if self.has_preferred_filesystem_module(module_name)
                && self.module_preference_requires_unload(module_name)
            {
                self.unregister_module(module_name);
