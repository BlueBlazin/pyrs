...
pub struct WasmWorkerInfoFixture {
    ...
    pub expected_lifecycle_supported: bool,
    pub expected_vm_probe_lifecycle_supported: Option<bool>,
...
pub struct WasmWorkerSessionStateSequenceFixture {
    pub name: &'static str,
    pub trigger_actions: &'static [&'static str],
    pub timeout_ms: u32,
    pub expected_execute_phase: &'static str,
    pub expected_execute_state: &'static str,
    pub expected_execute_blocker_key: Option<&'static str>,
...
pub const WASM_WORKER_INFO_FIXTURES: &[WasmWorkerInfoFixture] = &[WasmWorkerInfoFixture {
    ...
    expected_lifecycle_supported: false,
    expected_vm_probe_lifecycle_supported: Some(true),
...
pub const WASM_WORKER_SESSION_STATE_GATE_FIXTURES: &[WasmWorkerSessionStateGateFixture] = &[
    ...
    WasmWorkerSessionStateGateFixture {
        name: "session_state_gate_after_start",
...
pub const WASM_WORKER_SESSION_STATE_SEQUENCE_FIXTURES: &[WasmWorkerSessionStateSequenceFixture] = &[
    WasmWorkerSessionStateSequenceFixture {
        name: "session_state_sequence_terminate_then_start",
        trigger_actions: &["terminate", "start"],
        timeout_ms: 5_000,
        expected_execute_phase: "unsupported_worker_execution",
        expected_execute_state: "unwired",
        expected_execute_blocker_key: Some("worker_runtime_unwired"),
    ...
    WasmWorkerSessionStateSequenceFixture {
        name: "session_state_sequence_start_then_terminate",
        trigger_actions: &["start", "terminate"],
        timeout_ms: 5_000,
        expected_execute_phase: "unsupported_worker_execution",
        expected_execute_state: "unwired",
        expected_execute_blocker_key: Some("worker_runtime_unwired"),
    ...
    WasmWorkerSessionStateSequenceFixture {
        name: "session_state_sequence_start_then_terminate_then_start",
        trigger_actions: &["start", "terminate", "start"],
        timeout_ms: 5_000,
        expected_execute_phase: "unsupported_worker_execution",
        expected_execute_state: "unwired",
        expected_execute_blocker_key: Some("worker_runtime_unwired"),
    ...
    WasmWorkerSessionStateSequenceFixture {
        name: "session_state_sequence_terminate_then_recycle",
        trigger_actions: &["terminate", "recycle"],
        timeout_ms: 5_000,
        expected_execute_phase: "unsupported_worker_execution",
        expected_execute_state: "unwired",
        expected_execute_blocker_key: Some("worker_runtime_unwired"),
