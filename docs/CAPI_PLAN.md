...
- Stable ABI function exports implemented: `279 / 782`
...
- Stable ABI functions implemented/exported: `279 / 782`
...
- Added ABI conformance coverage:
  ...
  - behavior gate: `tests/extension_smoke.rs::cpython_compat_list_set_exception_gc_and_float_apis_work`
