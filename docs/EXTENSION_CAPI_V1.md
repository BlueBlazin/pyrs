...
| buffer helpers (`get_buffer`/`get_writable_buffer`/`release_buffer`) | `dynamic_extension_can_use_buffer_apis`, `dynamic_extension_can_use_writable_buffer_apis`, `dynamic_extension_buffer_pin_blocks_bytearray_resize_until_release`, `dynamic_extension_buffer_api_handles_memoryview_slices_and_release`, `dynamic_extension_can_bridge_buffer_pointer_through_capsule` |
