...
| CPython builtin surface parity gate (`docs/BUILTIN_PARITY.md`) | `[x]` | Automated gate is green with empty allowlists (`145/145` names, zero probe mismatches) |
...
- `[x]` Builtin parity gate is active and allowlists are empty
