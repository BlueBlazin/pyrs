...
| VM throughput/perf closure vs CPython for production workloads | `[~]` | Initial hot-path wins landed (fast locals, function-call clone reduction, release LTO tuning); substantial gap remains and needs continued dispatch/allocation optimization |
