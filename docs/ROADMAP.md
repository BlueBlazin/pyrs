...
- Remaining copyreg-family blocker is now isolated to pickle opcode-table parity (`test/test_copyreg.py` currently fails through `pickletools` consistency checks) and is explicitly carried in stub accounting for Milestone 13 closure.
