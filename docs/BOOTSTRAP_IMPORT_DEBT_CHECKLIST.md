...
- [ ] `P0` Remove placeholder behavior in `typing`:
  ...
  - remaining debt: `TypingIdFunc` still backs `overload`, `dataclass_transform`, and `no_type_check_decorator` (module install at line 3765, placeholder class wiring around lines 3759-3843).
