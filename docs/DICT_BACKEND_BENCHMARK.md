...
1. `pyrs_dict_microbench_sec=0.24`
2. `cpython_dict_microbench_sec=0.02`
3. `pyrs_pickle_hotspot_sec=5.01`
4. `cpython_pickle_hotspot_sec=0.43`
5. `pyrs_vs_cpython_pickle_ratio=11.6512`
6. `pickle_delta_vs_prev_sec=-34.8600`

## Interpretation

1. The new dict backend removed the previous major pickle bottleneck.
2. Pickle hotspot runtime improved from `39.87s` baseline to `5.01s` (`-34.86s`).
