...
3. `pyrs_pickle_hotspot_sec=4.88`
4. `cpython_pickle_hotspot_sec=0.41`
5. `pyrs_vs_cpython_pickle_ratio=11.9024`
6. `pickle_delta_vs_prev_sec=-34.9900`

## Interpretation

1. The new dict backend removed the previous major pickle bottleneck.
2. Pickle hotspot runtime improved from `39.87s` baseline to `4.88s` (`-34.99s`).
